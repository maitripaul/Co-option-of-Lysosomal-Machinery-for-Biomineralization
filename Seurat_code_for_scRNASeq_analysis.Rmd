...
DE_genes_lysosomal_sclerocyte <- read.csv("data/DE_sclerocyte_genes_logfold1_lysosomal_S_lacustris.csv")

genes_of_interest <- DE_genes_lysosomal_sclerocyte$gene_name
...
lysosomal_dot_plot <- DotPlot(sl_filtered, features = rev(genes_of_interest), group.by = "cell_type") +
   scale_x_discrete(labels = function(x) {
    ...
    sapply(x, function(g) {
      if (g %in% DE_genes_lysosomal_sclerocyte$gene_name) {
       DE_genes_lysosomal_sclerocyte$name[DE_genes_lysosomal_sclerocyte$gene_name == g]
      } else {
